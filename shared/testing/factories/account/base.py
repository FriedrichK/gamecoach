...
def create_accounts(number, is_superuser=False, is_staff=False, is_active=True, is_mentor=True):
    accounts = []
...
def create_account(is_superuser=False, is_staff=False, is_active=True, is_mentor=True):
    entries = {}
    ...
    entries['profiles']['mentor'] = create_mentor_profile(user, profile, is_mentor)
