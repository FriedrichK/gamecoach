...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'GamecoachProfile.email'
        db.add_column(u'profiles_gamecoachprofile', 'email',
                      self.gf('django.db.models.fields.CharField')(max_length=128, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'GamecoachProfile.email'
        db.delete_column(u'profiles_gamecoachprofile', 'email')
