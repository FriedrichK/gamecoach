...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting model 'GamecoachProfileStudent'
        db.delete_table(u'profiles_gamecoachprofilestudent')

        # Adding field 'GamecoachProfile.is_mentor'
        db.add_column(u'profiles_gamecoachprofile', 'is_mentor',
    ...
    def backwards(self, orm):
        ...
        db.create_table(u'profiles_gamecoachprofilestudent', (
            ...
            ('mentoring', self.gf('django.db.models.fields.CharField')(max_length=512, null=True, blank=True)),
        ...
        # Deleting field 'GamecoachProfile.is_mentor'
        db.delete_column(u'profiles_gamecoachprofile', 'is_mentor')
    ...
    models = {
        ...
        u'profiles.gamecoachprofile': {
            ...
            'created': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 8, 3, 0, 0)', 'blank': 'True'}),
            ...
            'updated': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 8, 3, 0, 0)', 'blank': 'True'}),
