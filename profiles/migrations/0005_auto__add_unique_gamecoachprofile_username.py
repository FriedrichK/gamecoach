...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'GamecoachProfile', fields ['username']
        db.create_unique(u'profiles_gamecoachprofile', ['username'])


    def backwards(self, orm):
        # Removing unique constraint on 'GamecoachProfile', fields ['username']
        db.delete_unique(u'profiles_gamecoachprofile', ['username'])
    ...
    models = {
        ...
        u'profiles.gamecoachprofile': {
            ...
            'created': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 8, 10, 0, 0)', 'blank': 'True'}),
            ...
            'updated': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 8, 10, 0, 0)', 'blank': 'True'}),
